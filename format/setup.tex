...
\makeatletter
    ...
    \newcommand{\makethesisheaders} {
        ...
        \begin{titlepage}
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{lrc}
                    ...
                    \rule{0pt}{1.07cm}&\xiaosi\hei{学~生~姓~名 :} & \underline{\parbox[c]{6cm}{\@author}} \\
                    \rule{0pt}{1.07cm}&\xiaosi\hei{学~生~学~号 :} & \underline{\parbox[c]{6cm}{\@studentid}} \\
                    \rule{0pt}{1.07cm}&\xiaosi\hei{专~业~班~级 :} & \underline{\parbox[c]{6cm}{\@major}} \\
                    \rule{0pt}{1.07cm}&\xiaosi\hei{学~院~名~称 :} & \underline{\parbox[c]{6cm}{\@faculty}} \\
                    \rule{0pt}{1.07cm}&\xiaosi\hei{指~导~老~师 :} & \underline{\parbox[c]{6cm}{\@teacher}} \\
                \end{tabular}
            \end{table}\par
            \vspace{2em}
        ...
        \def\headrule{ 
            ...
            \fi
            \hrule\@height 1.2pt \@width\headwidth          % 上面线为1pt粗
            \vskip 0.6pt
