...
\newcommand{\mainmatter} {
    % \clearpage
    \clearpage
    \cfoot{\song\wuhao{\thepage}} % ? 暂时不知道如何描述这里的功能。
...
\titleformat{\paragraph}[display]{\xiaosi\hei}{\theparagraph}{2em}{\arabic{paraCounter}. }[]
\titlespacing{\paragraph}{0pt}{6pt}{6pt}

\newcommand{\subsubsubsection}[2]{
    \ifthenelse{\equal{#1}{}}{
        % 不要求就累加
        \addtocounter{paraCounter}{1}
    } % else
    { % 否则清为 1
        \setcounter{paraCounter}{1}
    }
...
\deffootnotemark{\textsuperscript{\smash{\circled{\erhao{\thefootnotemark}}}}}
    ...
    \newcommand{\makethesisheaders} {
        ...
        \begin{titlepage}
            ...
            \begin{overpic}{figures/HSVGPDF}
                ...
                \put(0,75){\yihao\textbf{\texttt{HUNAN UNIVERSITY}}}
