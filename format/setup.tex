...
\newcommand\circled[2][.30]{\scalerel*{\tikz{\useasboundingbox (-#1,-#1) rectangle (#1,#1);\node{#2};\draw circle[radius=#1];}}{X}}
\deffootnotemark{\textsuperscript{\smash{\circled{\sihao{\thefootnotemark}}}}}
...
\makeatletter
    ...
    \newcommand{\makethesisheaders} {
        ...
        \begin{titlepage}
            ...
            \begin{overpic}{figures/HSVGPDF}
                \put(-16,75){\yihao\textbf{\texttt{HUNAN UNIVERSITY}}}
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{lrc}
                    ...
                    \multicolumn{2}{r}{\xiaoer\hei\textbf{论文(设计)题目:}}\rule{0pt}{1.05cm} & \underline{\parbox[c]{6cm}{\@titleOnTheFirstLine}} \\
            ...
            \end{table}\par
            \vspace{2em}
            \centering{\sihao\hei{\the\year{} 年 \the\month{} 月 \quad 日}}
        \end{titlepage}
        \clearpage
        %% 从此往后页眉的格式固定。
        \setHeaderAndFoot
        ...
        \addcontentsline{toc}{section}{毕业论文（设计）原创性声明和毕业论文（设计）版权使用授权书} { 
            　\par
            \hei\xiaoer{\vspace*{-0.4em}\hspace*{8em}湖\hspace{0.5em}南\hspace*{0.5em}大\hspace{0.5em}学\vspace*{.6em}}\par
            \hei\xiaoer{\vspace*{.8em}\hspace*{4em}毕业论文（设计）原创性声明\vspace{1em}}\par
            \song\defaultfont{
            ...
            \vspace{-0.25em}\hspace{7.5em}1、保　密\symbol{"25A1}，在\underline{\hspace{4em}}年解密后适用于本授权书。\par
            \vspace{-0.25em}\hspace{7.5em}2、不保密\symbol{"25A1}。\par
    ...
    \newcommand{\makeproposalheader}{
        \begin{titlepage}
            ...
            \begin{figure*}[htp]
                ...
                \includegraphics[width=0.5\textwidth]{figures/hnu}
            \end{figure*}
            \vspace{1em}\centerline{\heiti\fontsize{33pt}{33pt}\textbf{毕业论文(设计)开题报告}}\par
            \vspace{2em}\centerline{\heiti\xiaoyi\heiti{（全日制本科生）}}\par
            \begin{table}[H]
                \centering
                \begin{tabular}{cl}
                    % multicolumn 必须是第一条指令，前面只能是字体而不掺杂任何的命令。\@faculty
                    \rule{0pt}{1.48cm}\textbf{\xiaosan\hei{课~~题~~名~~称}} &\underline{\parbox[l]{7.57cm}{\xiaosan\heiti{\@title}}} \\
                    \rule{0pt}{1.48cm}\textbf{\xiaosan\hei{课~~题~~类~~别}} &\underline{\parbox[l]{7.57cm}{\xiaosi\heiti{~~设计~□~~~论文~□}}} \\
                    \rule{0pt}{1.48cm}\tableCellAdjust{\textbf{\xiaosan\hei{论文\hspace*{-0.5em}（设计）}}}{\textbf{\xiaosan\hei{题~~~\qquad~~~目}}} &\underline{\parbox[l]{7.57cm}{\xiaosan\hei{\@title}}} \\
                    \rule{0pt}{1.48cm}\tableCellAdjust{\textbf{\xiaosan\hei{学~~生~~所~~在}}}{\textbf{\xiaosan\hei{专~业、班~级}}} &\underline{\parbox[l]{7.57cm}{\xiaosan\heiti{\@major}}} \\
                    \rule{0pt}{1.48cm}\textbf{\xiaosan\hei{学~~~\qquad~~~生}} &\underline{\parbox[l]{7.57cm}{\xiaosan\heiti{\@author}}} \\
                    \rule{0pt}{1.48cm}\textbf{\xiaosan\hei{学~~~\qquad~~~号}} &\underline{\parbox[l]{7.57cm}{\xiaosan\heiti{\@studentid}}} \\
                    \rule{0pt}{1.48cm}\textbf{\xiaosan\hei{指~~导~~老~~师}} &\underline{\parbox[l]{7.57cm}{\xiaosan\heiti{\@teacher}}} \\
                \end{tabular}
            \end{table}
        \end{titlepage}
        \newpage
        \centerline{\textbf{\xiaoyi\hei{开题报告填写要求}}}\par\vspace{2em}
        \begin{spacing}{3}
            \vspace{6pt}\sihao\heiti{
            一、开题报告是毕业论文（设计）答辩委员会对学生答辩资格审查的内容之一。
            此报告应在指导教师指导下，由学生在毕业论文（设计）工作前期完成，经指导教师签署意见及所在专业审查后生效。
        }\vspace{6pt}
        
        \vspace{6pt}\sihao\heiti{
            二、开题报告在教学信息化服务平台填写后导出打印，打印时必须是双面打印，可以按需加页。
            开题报告填写完成后应及时交给指导教师签署意见。
        }\vspace{6pt}
    ...
    \setHeaderAndFoot % ? 暂时不知道如何描述这里的功能。
\makeatother
%%% 附录命令配置
