...
%% https://tex.stackexchange.com/questions/639370/how-to-enumerate-footnotes-with-circled-numbers/639377#639377
\newcommand\circled[2][.30]{%
    \scalerel*{\tikz{\useasboundingbox (-#1,-#1) rectangle (#1,#1);\node{#2};\draw circle[radius=#1];}}{X}
}
\deffootnotemark{\textsuperscript{\smash{\circled{\xiaowu{\thefootnotemark}}}}}
% \makeatletter
%     % https://tex.stackexchange.com/a/587493
%     \renewcommand\@makefntext[1]{%
%     \setlength\parindent{1em}%    
%     \noindent\mbox{\circled{\@thefnmark}\hspace{1em}}{#1}} % TODO: thefnmark 的格式.
% \makeatother
