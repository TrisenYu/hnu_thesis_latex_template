...
\setAppendixHere{A}
    ...
    所形成的交换图如图 \ref{fig1}，图 \ref{fig2}，图 \ref{fig3} 和图 \ref{performanceOfSCLL} 所示。
    \begin{figure*}[htp]
        \centering
        \begin{tikzcd}
        ...
        \begin{tikzpicture}
            \begin{axis}
                [
                    ymode=log,
                    x=4cm, xtick=data,
                    ybar=6pt, ylabel={$\ln[\operatorname{ms}]$}, ylabel style={rotate=-90, at={(0,1)},anchor=west},
                    symbolic x coords={SCLL,Python,Java,C},
                    nodes near coords,
                    nodes near coords align={vertical},
                    bar width=14pt,
                    width=0.8*\linewidth,
                ] 
                \addplot coordinates {(SCLL, 8755) (Python, 1953) (Java, 79) (C, 48) } ; 
                \addplot coordinates {(SCLL, 9829) (Python, 3406) (Java, 108.9) (C, 87) }; 
                \addplot coordinates {(SCLL, 10054) (Python, 1897) (Java, 80) (C, 45) }; 
                
                \legend{{Fibonacci, n = 35}, {Primes, n = 1000000}, {Pascal triangle, n = 23}}; 
            \end{axis} 
        \end{tikzpicture} 
        \caption{性能统计图表}
...
% \begin{lstlisting}[
%     language=python,
%     basicstyle=\ttfamily+\CJKfamily,
%     keywordstyle=\bfseries\color{NavyBlue},
%     emph={self},
%     columns=flexible,                           % 更加紧凑
